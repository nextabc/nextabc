  ...
  function CarouselDirective() {
    ...
    function link(scope, element, attrs, vm) {
      ...
      if (attrs.autoSlideTime === undefined) {
        vm.autoSlideTime = 5000;
      }
      vm.registerElement(element);
      scope.$on('$destroy', function() {
        vm.stopAutoSlide();
      });
      scope.$watch('vm.autoSlide', function() {
        vm.validateAutoSlide();
      });
      scope.$watch('vm.autoSlideTime', function() {
        vm.restartAutoSlide();
      });
    }
