function homeNavigate(keyCode, curItem) {
    ...
    switch (keyCode) {
        ...
        case 38: // up
            ...
            if (current_Item.hasClass('slider_cate')) {
                if (current_Item.is(".slider_cate:first")) {
                    ...
                    current_Item.removeClass('item-hover');
                    current_Item = current_Item.closest(".row-fill").prev().find("div.sli.slick-active:first");
                    current_Item.addClass('item-hover');
        ...
        case 40: // down
            ...
            if (current_tag === "A") {
                ...
                current_Item = current_Item.closest(".row-fill").find("div.sli.slick-active:first");
                current_Item.addClass('item-hover');
                // current_Item.mouseover();
